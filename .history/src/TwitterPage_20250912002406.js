          ...
          <div style={profileInfoCardStyle}>
            ...
            <div style={profileInfoStyle}>
              ...
              <div style={statsStyle}>
                ...
                <div>
                  <strong>Listed:</strong> {userData?.data?.result?.data?.user?.result?.legacy?.listed_count}
                </div>
                <div>
                  <strong>Favorites:</strong> {userData?.data?.result?.data?.user?.result?.legacy?.favourites_count}
                </div>
                <div>
                  <strong>Media:</strong> {userData?.data?.result?.data?.user?.result?.legacy?.media_count}
                </div>
              </div>
              ...
              {/* Additional Info */}
              <p>
                <strong>Location:</strong> {userData?.data?.result?.data?.user?.result?.location?.location || "Not provided"}
              </p>
              <p>
                <strong>Account Created At:</strong> {userData?.data?.result?.data?.user?.result?.core?.created_at}
              </p>
            </div>
          </div>
        </div>
