        ...
        <div style={profileCardStyle}>
          ...
          <div style={profileInfoCardStyle}>
            ...
            <div style={profileInfoStyle}>
              ...
              <p>@{userData?.data?.result?.data?.user?.result?.core?.screen_name}</p>
              <p>{userData?.data?.result?.data?.user?.result?.legacy?.description}</p>
              <p>Location: {userData?.data?.result?.data?.user?.result?.location?.location || "Not Provided"}</p>
              <p>Followers: {userData?.data?.result?.data?.user?.result?.legacy?.followers_count}</p>
              <p>Following: {userData?.data?.result?.data?.user?.result?.legacy?.friends_count}</p>
              <p>Profile URL: <a href={userData?.data?.result?.data?.user?.result?.legacy?.url} target="_blank" rel="noopener noreferrer">Visit Profile</a></p>
              <p>Verified: {userData?.data?.result?.data?.user?.result?.verification?.verified ? "Yes" : "No"}</p>
            </div>
          </div>
        </div>
      )}
