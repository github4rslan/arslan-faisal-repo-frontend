  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link to="/whatsapp-checker" style={cardStyle}>📱 WhatsApp Checker</Link>

        {/* New Web3 Card */}
        <Link to="/web3" style={cardStyle}>🌐 Web3</Link>

        {/* New Twitter Page Card */}
        <Link to="/twitter" style={cardStyle}>🐦 Twitter Profile</Link>
