...
export default function Web3Page() {
  ...
  const sendPayment = async () => {
    ...
    // Prevent sending payment to own account
    if (recipient === account) {
      setStatusMessage("You cannot send payment to your own account.");
      return;
    }

    // Validate recipient address format
    if (!window.ethereum.utils.isAddress(recipient)) {
    ...
    try {
      ...
      setStatusMessage("Error: Payment failed. Please check your MetaMask.");
    }
