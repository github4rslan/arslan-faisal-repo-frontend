...
const Chatbot = () => {
  ...
  // Function to format the bot's response cleanly
  const formatMessage = (msg) => {
    // If the message contains an answer in paragraph format, add <p> tags for better spacing
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      setMessages((prevMessages) => [
        ...
        { role: 'bot', text: formatMessage(chatbotMessage) }, // Formatted bot's response
      ]);
    } catch (error) {
